...
namespace MovieLib.Data.Sql
{
    ...
    public class SqlMovieDatabase : MovieDatabase
    {
        ...
        /// //CR1 Jonathan Byrne - added override keyword, set database as startup project to deploy it,
        /// // then set .web project back to startup project and web now compiles clean
