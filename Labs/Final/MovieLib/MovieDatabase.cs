...
namespace MovieLib.Data
{
    ...
    public abstract class MovieDatabase : IMovieDatabase
    {
        ...
        /// //CR1 Jonathan Byrne - Capitalized the A in GetAll
        ...
        public bool Remove ( int id )
        {
            ...
            //CR4 Jonathan Byrne - changed existing != null to existing == null in the if statement
            //database now properly deletes movies
            if (existing == null)
                return false;
